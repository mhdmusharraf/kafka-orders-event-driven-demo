  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setError("Unable to fetch data from backend. Check if backend is running.");
      }
    }
          ...
          <Stack spacing={4}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <Card className="bg-slate-950/80 border border-slate-800">
                  <CardContent>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="rounded-full bg-blue-500/10 p-3">
                        <ShoppingCartIcon className="text-blue-400" fontSize="large" />
                      </div>
                    </div>
                    <Typography
                      variant="body2"
                      ...
                      className="mt-2"
                    >
                      Total number of orders successfully processed by the consumer.
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
                ...
                <Card className="bg-slate-950/80 border border-slate-800">
                  <CardContent>
                    ...
                    <Typography
                      ...
                      className="mt-2"
                    >
                      Running average of order price across all processed orders.
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
            ...
            {/* Per-Product Table */}
            <Paper className="bg-slate-950/80 border border-slate-800 overflow-hidden">
              <Box className="p-4">
                <Typography variant="h6" className="mb-1">
                  Per-Product Averages
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Live statistics of order counts and average prices per product.
                </Typography>
              </Box>
              <Divider />
            ...
            <Paper className="bg-slate-950/80 border border-slate-800 overflow-hidden">
              <Box className="p-4 flex items-center gap-2">
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Messages that eventually failed processing and were sent to the Dead Letter Queue.
                  </Typography>
                </Box>
              </Box>
              <Divider />
